...
| Resource                        | Description                                                             |
| -                               | -                                                                       |
| [Account](#account)             | Allows you to view and manage basic information about your account like |
...
| Resource                      | Description                                                                         |
| -                             | -                                                                                   |
| [Auth](#auth)                 | Verifies if the given token is valid or not. If it is valid it will                 |
| [AWSAccount](#awsaccount)     | Allows you to bind an AWS account to your Aporeto account to allow auto-registra... |
...
| Resource                                    | Description                                                        |
| -                                           | -                                                                  |
| [Enforcer](#enforcer)                       | Contains all parameters associated with a registered enforcer. The |
...
| [TraceMode](#tracemode)                     | Represents the tracing mode to apply to a processing unit.         |
...
| Resource                  | Description                                                                         |
| -                         | -                                                                                   |
| [Activity](#activity)     | Contains logs of all the activity that happened in a namespace. All successful o... |
| [Alarm](#alarm)           | Represents an event requiring attention.                                            |
...
| Resource                                    | Description                                                              |
| -                                           | -                                                                        |
| [DataPathCertificate](#datapathcertificate) | Used by enforcer instances to retrieve various certificates used         |
...
| [UIParameter](#uiparameter)                     | Represents a parameter that will be shown in the web interface.      |
| [UIParameterVisibility](#uiparametervisibility) | Represents a visibility condition for a [UIParameter](#uiparameter). |
| [UIStep](#uistep)                               | Represents a step that will be shown in the web interface.           |
...
| Resource                      | Description                                        |
| -                             | -                                                  |
| [App](#app)                   | Represents an application that can be installed.   |
| [Category](#category)         | Allows you to categorize services.                 |
...
| Resource                                  | Description                                                                         |
| -                                         | -                                                                                   |
| [Automation](#automation)                 | Allows you to define some code and specify the conditions under which it should ... |
| [AutomationTemplate](#automationtemplate) | Templates that can be used in automations.                                          |
...
| Resource              | Description                                                      |
| -                     | -                                                                |
| [PKIXName](#pkixname) | Represents a public key infrastructure X.509 (PKIX) certificate. |
...
| Resource                      | Description                             |
| -                             | -                                       |
| [AccessReport](#accessreport) | Represents any access made by the user. |
...
| Resource                                                | Description                                                                         |
| -                                                       | -                                                                                   |
| [AuditProfile](#auditprofile)                           | A set of audit rules that determine the types of events that must be captured in... |
| [AuditProfileMappingPolicy](#auditprofilemappingpolicy) | Use an audit profile mapping to define the set of enforcers that must               |
| [AuditReport](#auditreport)                             | Post a new audit report.                                                            |
...
| Resource                                          | Description                                                               |
| -                                                 | -                                                                         |
| [APIAuthorizationPolicy](#apiauthorizationpolicy) | An API authorization defines the operations a user can perform in a       |
| [APICheck](#apicheck)                             | Allows you to verify if a client identitied by his token is allowed to do |
| [AppCredential](#appcredential)                   | Create an app credential.                                                 |
| [Credential](#credential)                         | Represents an app credential.                                             |
...
| Resource                                      | Description                                                                         |
| -                                             | -                                                                                   |
| [Claims](#claims)                             | Represents the claims in the token used to access a service.                        |
...
| Resource                                | Description                                                                         |
| -                                       | -                                                                                   |
| [ClaimMapping](#claimmapping)           | Allows you to map a claim in a token to an HTTP header. This can be useful          |
...
| Resource                        | Description                |
| -                               | -                          |
| [RecipeOptions](#recipeoptions) | Represents recipe options. |
...
| Resource                            | Description                                                                     |
| -                                   | -                                                                               |
| [DependencyMap](#dependencymap)     | Returns a data structure representing the graph of all processing units         |
...
| [GraphPolicyInfo](#graphpolicyinfo) | Represents policy information.                                                  |
...
| [TimeSeriesRow](#timeseriesrow)                   | Represents a time-series row.                                                  |
